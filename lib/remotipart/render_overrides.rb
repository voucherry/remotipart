  ...
  module RenderOverrides
    ...
    def render_with_remotipart *args
      ...
      if remotipart_submitted?
        ...
        response.body = %{<script type=\"text/javascript\">document.domain = "#{request.host}"</script> <textarea data-type=\"#{response.content_type}\" data-status=\"#{response.response_code}\" data-statusText=\"#{response.message}\">#{textarea_body}</textarea>}
